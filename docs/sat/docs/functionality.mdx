...
<Admonition type="success" title="Perfect for Leadership">
A streamlined, high-level view specifically designed for stakeholders and executives who need quick insights without technical details.
</Admonition>
...
**🔧 Troubleshooting**  
[Find Solutions](./troubleshooting.mdx)
