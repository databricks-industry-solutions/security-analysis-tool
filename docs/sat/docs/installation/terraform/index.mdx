...
After installing SAT using DABs or Terraform, you will need to manually complete the Permissions Analysis app deployment and configuration by following these steps:
