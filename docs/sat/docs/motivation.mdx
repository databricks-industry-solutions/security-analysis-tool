...
<Admonition type="tip" title="What SAT Does">
...
<Admonition type="warning" title="Assessment Tool - Not a Certification">
...
<div style={{padding: '1.5rem', border: '2px solid #e0e0e0', borderRadius: '8px', textAlign: 'center'}}>

**📥 Installation**  
Set up SAT in your environment

[Get Started →](./installation/standard/index.mdx)
...
**🔍 Learn More**  
Explore SAT capabilities

[View Features →](./functionality.mdx)
