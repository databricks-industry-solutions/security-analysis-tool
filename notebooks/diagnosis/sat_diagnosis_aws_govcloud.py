...
# MAGIC %md 
# MAGIC **Functionality:** Diagnoses account-level and workspace-level connections for Databricks workspaces on AWS GovCloud to ensure proper configuration and connectivity.
...
def getAWSTokenwithOAuth(source, baccount, client_id, client_secret):
        ...
        if baccount is True:
            full_endpoint = f"https://accounts.cloud.databricks.us/oidc/accounts/{source}/v1/token" 
        else: 
