...
|--------|-------|-------------|
| AGREE | 55 | API ground truth matches SAT result |
| DISAGREE | 5 | API and SAT disagree on pass/fail |
| SAT_MISSING | 3 | Check not found in SAT output for this run |
...
- **API details:** `{'mounts': ['/mnt/checkpoints', '/mnt/cluster-logs', '/mnt/dbacademy-datasets', '/mnt/dbacademy-users', '/mnt/dv-db-personalbucket', '/mnt/hardcoded_creds_test', '/mnt/sample', '/mnt/training'], 'count': 8}`
...
- **API details:** `{'note': 'DBFS scripts path not accessible'}`
- **SAT says:** score=1 (FAIL)
- **SAT details:** `{"scripts":"[[\"/databricks/init/Silvio_s Dev Cluster\",true],[\"/databricks/init/output\",true],[\"/databricks/init/bar.sh\",false],[\"/databricks/init/foo\",true]]"}`
...
| DP-14 | Store and retrieve embeddings securely | Data Protection | Low | PASS | PASS | AGREE |
...
| GOV-11 | DBFS mounts | Governance | Low | FAIL | PASS | DISAGREE |
...
| GOV-25 | Init scripts stored in DBFS | Governance | High | PASS | FAIL | DISAGREE |
...
| GOV-42 | Jobs run as service principal | Governance | Medium | FAIL | FAIL | AGREE |
...
| IA-8 | PAT token creation restricted to admins | Identity & Access | Medium | FAIL | FAIL | AGREE |
...
| INFO-40 | Enhanced security monitoring for the workspace | Informational | Low | PASS | PASS | AGREE |
...
| NS-3 | Front-end private connectivity | Network Security | Medium | PASS | PASS | AGREE |
