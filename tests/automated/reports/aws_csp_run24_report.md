# SAT Validation Report - AWS — CSP

**Generated:** 2026-04-01 15:01:39  
**SAT Run ID:** 24  
**Cloud:** aws — csp  
...
|--------|-------|-------------|
| AGREE | 60 | API ground truth matches SAT result |
...
| DP-2 | Cluster instance disk encryption | Data Protection | Low | PASS | PASS | AGREE |
...
| GOV-45 | Jobs not granting CAN_MANAGE to non-admin principals | Governance | High | PASS | PASS | AGREE |
...
| INFO-29 | Streamline the usage and management of various large language model(LLM) providers | Informational | Medium | FAIL | FAIL | AGREE |
...
| INFO-39 | Compliance security profile for the workspace | Informational | Low | PASS | PASS | AGREE |
